...
`GenHlth (0.41): Worse general health is moderately correlated with diabetes`

`HighBP (0.38): 	Having high blood pressure is positively correlated with diabetes `
...
`HighChol (0.29): Moderate positive correlation. `

`BMI (0.29): Moderate correlation. Obesity (higher BMI) Higher BMI is associated with diabetes.`

`Diff walk (0.27): Moderately correlated. People whonhave diffculty walking has tend to more diabetic.`

`HeartDiseaseorAttack (0.21): Moderate correlation. Heart disease is a common comorbidity or consequence of diabetes, or they share common risk factors.`

`PhysActivity (-0.16): Weak negative correlation. Physical activity is slightly protective`

`Education (-0.17): Weak negative correlation.Higher education is slightly protective`

`Income (-0.22): Higher income is negatively correlated with diabetes.`


`**Weak to Very Weak Correlations with Diabetes:**`

`MentHlth (-0.09), Smoker (0.09), Stroke (0.13), Fruits (-0.05), Veggies (-0.08), AlcoholConsump (-0.09), AnyHealthcare (0.02), NoDocbcCost (0.04).`

I want to investigate by doing some more correlation test to find out more details.

**`For numerical variables I am using Point-Biserial Correlation method`**
"""
...
"""`**Point-Biserial Correlation BMI: 0.29, P-value: 0.0000**`

`**Point-Biserial Correlation Mental health 0.09, P-value: 0.0000**`

`**Point-Biserial Correlation Physical health 0.21, P-value: 0.0000**`
...
"""--- Chi-Square Test Results for HighBP vs Diabetes_binary ---
Chi-Square Statistic: 10287.9730
P-value: 0.0000
Degrees of Freedom: 1
Since p-value (0.0000) < alpha (0.05), we reject the null hypothesis.
There is a statistically significant association between HighBP and Diabetes_binary.

Cramer's V: 0.3815
Phi Coefficient (for 2x2 table): 0.3815

==================================================

--- Chi-Square Test Results for HighChol vs Diabetes_binary ---
Chi-Square Statistic: 5911.8067
P-value: 0.0000
Degrees of Freedom: 1
Since p-value (0.0000) < alpha (0.05), we reject the null hypothesis.
There is a statistically significant association between HighChol and Diabetes_binary.

Cramer's V: 0.2892
Phi Coefficient (for 2x2 table): 0.2892

==================================================

--- Chi-Square Test Results for CholCheck vs Diabetes_binary ---
Chi-Square Statistic: 939.6318
P-value: 0.0000
Degrees of Freedom: 1
Since p-value (0.0000) < alpha (0.05), we reject the null hypothesis.
There is a statistically significant association between CholCheck and Diabetes_binary.

Cramer's V: 0.1153
Phi Coefficient (for 2x2 table): 0.1153

==================================================

--- Chi-Square Test Results for Smoker vs Diabetes_binary ---
Chi-Square Statistic: 522.4811
P-value: 0.0000
Degrees of Freedom: 1
Since p-value (0.0000) < alpha (0.05), we reject the null hypothesis.
There is a statistically significant association between Smoker and Diabetes_binary.

Cramer's V: 0.0860
Phi Coefficient (for 2x2 table): 0.0860

==================================================

--- Chi-Square Test Results for Stroke vs Diabetes_binary ---
Chi-Square Statistic: 1111.0793
P-value: 0.0000
Degrees of Freedom: 1
Since p-value (0.0000) < alpha (0.05), we reject the null hypothesis.
There is a statistically significant association between Stroke and Diabetes_binary.

Cramer's V: 0.1254
Phi Coefficient (for 2x2 table): 0.1254

==================================================

--- Chi-Square Test Results for HeartDiseaseorAttack vs Diabetes_binary ---
Chi-Square Statistic: 3161.7202
P-value: 0.0000
Degrees of Freedom: 1
Since p-value (0.0000) < alpha (0.05), we reject the null hypothesis.
There is a statistically significant association between HeartDiseaseorAttack and Diabetes_binary.

Cramer's V: 0.2115
Phi Coefficient (for 2x2 table): 0.2115

==================================================

--- Chi-Square Test Results for PhysActivity vs Diabetes_binary ---
Chi-Square Statistic: 1778.9607
P-value: 0.0000
Degrees of Freedom: 1
Since p-value (0.0000) < alpha (0.05), we reject the null hypothesis.
There is a statistically significant association between PhysActivity and Diabetes_binary.

Cramer's V: 0.1586
Phi Coefficient (for 2x2 table): 0.1586

==================================================

--- Chi-Square Test Results for Fruits vs Diabetes_binary ---
Chi-Square Statistic: 206.5009
P-value: 0.0000
Degrees of Freedom: 1
Since p-value (0.0000) < alpha (0.05), we reject the null hypothesis.
There is a statistically significant association between Fruits and Diabetes_binary.

Cramer's V: 0.0540
Phi Coefficient (for 2x2 table): 0.0540

==================================================

--- Chi-Square Test Results for Veggies vs Diabetes_binary ---
Chi-Square Statistic: 444.0807
P-value: 0.0000
Degrees of Freedom: 1
Since p-value (0.0000) < alpha (0.05), we reject the null hypothesis.
There is a statistically significant association between Veggies and Diabetes_binary.

Cramer's V: 0.0793
Phi Coefficient (for 2x2 table): 0.0793

==================================================

--- Chi-Square Test Results for HvyAlcoholConsump vs Diabetes_binary ---
Chi-Square Statistic: 635.0865
P-value: 0.0000
Degrees of Freedom: 1
Since p-value (0.0000) < alpha (0.05), we reject the null hypothesis.
There is a statistically significant association between HvyAlcoholConsump and Diabetes_binary.

Cramer's V: 0.0948
Phi Coefficient (for 2x2 table): 0.0948

==================================================

--- Chi-Square Test Results for AnyHealthcare vs Diabetes_binary ---
Chi-Square Statistic: 37.7956
P-value: 0.0000
Degrees of Freedom: 1
Since p-value (0.0000) < alpha (0.05), we reject the null hypothesis.
There is a statistically significant association between AnyHealthcare and Diabetes_binary.

Cramer's V: 0.0231
Phi Coefficient (for 2x2 table): 0.0231

==================================================

--- Chi-Square Test Results for NoDocbcCost vs Diabetes_binary ---
Chi-Square Statistic: 118.4167
P-value: 0.0000
Degrees of Freedom: 1
Since p-value (0.0000) < alpha (0.05), we reject the null hypothesis.
There is a statistically significant association between NoDocbcCost and Diabetes_binary.

Cramer's V: 0.0409
Phi Coefficient (for 2x2 table): 0.0409

==================================================

--- Chi-Square Test Results for DiffWalk vs Diabetes_binary ---
Chi-Square Statistic: 5253.6948
P-value: 0.0000
Degrees of Freedom: 1
Since p-value (0.0000) < alpha (0.05), we reject the null hypothesis.
There is a statistically significant association between DiffWalk and Diabetes_binary.

Cramer's V: 0.2726
Phi Coefficient (for 2x2 table): 0.2726

==================================================

--- Chi-Square Test Results for Sex vs Diabetes_binary ---
Chi-Square Statistic: 139.2619
P-value: 0.0000
Degrees of Freedom: 1
Since p-value (0.0000) < alpha (0.05), we reject the null hypothesis.
There is a statistically significant association between Sex and Diabetes_binary.

Cramer's V: 0.0444
Phi Coefficient (for 2x2 table): 0.0444
...
"""Mann-Whitney U Statistic: 336113189.5000
P-value: 0.0000

Calculated Rank-Biserial Correlation (r_rb): 0.4619

Interpretation:
The rank-biserial correlation is 0.4619, indicating a medium/moderate positive association.
This means that as Diabetes_binary status changes from 0 to 1, there is a positive tendency in GenHlth ranks.

==================================================

Mann-Whitney U Statistic: 437110918.5000
P-value: 0.0000

Calculated Rank-Biserial Correlation (r_rb): 0.3003

Interpretation:
The rank-biserial correlation is 0.3003, indicating a medium/moderate positive association.
This means that as Diabetes_binary status changes from 0 to 1, there is a positive tendency in Age ranks.

==================================================

Mann-Whitney U Statistic: 741358377.0000
P-value: 0.0000

Calculated Rank-Biserial Correlation (r_rb): -0.1868

Interpretation:
The rank-biserial correlation is -0.1868, indicating a small/weak negative association.
This means that as Diabetes_binary status changes from 0 to 1, there is a negative tendency in Education ranks.

==================================================

Mann-Whitney U Statistic: 789400676.5000
P-value: 0.0000

Calculated Rank-Biserial Correlation (r_rb): -0.2637

Interpretation:
The rank-biserial correlation is -0.2637, indicating a small/weak negative association.
This means that as Diabetes_binary status changes from 0 to 1, there is a negative tendency in Income ranks.
...
`I found the correlation between the variables and the diabetes binary are moreover similar to heat map. I have decided to continue using this correlation result for my further analysis.`
